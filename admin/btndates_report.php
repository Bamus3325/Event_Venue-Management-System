...
<body>
    ...
    <div class="container-scroller">
                            ...
                            <div class="card">
                                ...
                                <div class="col-md-12 mt-4">
                                    <form class="forms-sample" method="post" enctype="multipart/form-data"
                                        ...
                                        <button type="submit" style="float: left;" name="search" id="submit"
                                            class="btn btn-info btn-sm  mb-4">Search</button>
                                    </form>
                                </div>
                            </div>
                        </div>
        ...
        if(isset($_POST['search']) & !empty($_POST['fromdate']))
        {
          ?>
            ...
            $tdate=$_POST['todate'];
            ?>
                                    <h5 align="center" style="color:blue">Report from <?php echo $fdate?> to
                                        <?php echo $tdate?></h5>
                                    <hr />
 ...
 Visit website : www.nikhilbhalerao.com -->
                                        <tbody>
                                            <?php
                $sql="SELECT * from tblbooking where date(ddate) between '$fdate' and '$tdate'";
                  ...
                  $row1 = mysqli_fetch_assoc($user); 
                      ...
                      ?>
                                            <tr>
                                                ...
                                                <td class="font-w600">
                                                    <span
                                                        class="badge badge-primary"><?php  echo htmlentities($row->cdate);?></span>
                                                </td>
                                                <td>
                                                <?php
                                      if ($row->Status == '0') {
                                       ?>
                                        ...
                                        ?> 
                                                ...
                                                <!-- <td class=" text-center"><a href="#"
                                                        class=" edit_data4 btn btn-info rounded"
                                                        id="<?php echo  ($row->ID); ?>" title="click to edit"><i
                                                            class="mdi mdi-eye" aria-hidden="true"></i></a>
                                                    <a href="invoice_generating.php?invid=<?php echo htmlentities ($row->ID);?>"
                                                        class="btn btn-primary rounded"><i class="mdi mdi-printer"
