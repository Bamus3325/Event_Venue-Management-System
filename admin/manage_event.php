                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="modal-header">
                                    <h5 class="modal-title" style="float: left;">List of Available Campus Events</h5>
                                    <div class="card-tools" style="float: right;">
                                        <button type="button" class="btn btn-sm btn-info" data-toggle="modal"
                                            data-target="#addsector"><i class="fas fa-plus"></i> Add Event
                                        </button>
                                    </div>
                                </div>
                      ...
                      foreach($results as $row)
                        {               ?>
                                            <tr>
                                                ...
                                                <td class="font-w600"><?php  echo htmlentities($row->event);?></td>
                                                <td class="font-w600"><?php  echo htmlentities($row->cdate);?></td>
                                                <td class="d-none d-sm-table-cell">
                                                    <?php  echo htmlentities($row->descr);?></td>
                                                <td class="text-center">
                                                    <a href="manage_event.php?delid=<?php echo ($row->ID);?>"
                                                        onclick="return confirm('Do you really want to Delete ?');"
                                                        class="rounded btn btn-danger"><i class="mdi mdi-delete"
