            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto my-2 my-lg-0">
                    ...
                    if (isset($_SESSION['Email'])) {
                        ?>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=book">My Bookings</a>
                        </li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=payment">Payments</a>
                    </li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger">Hi <?php echo $_SESSION['username']; ?></a>
                        </li>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 mr-auto text-center">
                    ...
                    <a class="d-block"
                        href="#">user@gmail.com</a>
                </div>
            </div>
        </div>
        <br>
        <div class="container">
            <div class="small text-center text-muted">Copyright © 2024 -  | <a
                    href="https://www.sourcecodester.com/" target="_blank">Designed By: Arowolo kehinde Emmanuel CS/HND/F22/3365</a></div>
        </div>
